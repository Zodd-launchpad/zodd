...
export const translations = {
  ...
  "nftMarket.forge.tier.papiro": { en: "Papiro", zh: "纸莎草" },
  "nftMarket.forge.tier.fragmento": { en: "Fragmento", zh: "碎片" },
  "nftMarket.forge.tier.reliquia": { en: "Reliquia", zh: "圣物" },
  "nftMarket.forge.intro": {
    en: "Combine your pieces here: 5 Papiros forge into 1 Fragmento, and 3 Fragmentos forge into 1 Reliquia. Crafting burns the pieces you feed in -- it can't be undone.",
  ...
  "nftMarket.forge.reliquiaOwned": { en: "You own {count} Reliquia(s) -- that unlocks LA PIRAMIDE.", zh: "你拥有 {count} 个圣物——已解锁金字塔（LA PIRAMIDE）。" },
  ...
  "pyramid.subtitle": {
    en: "Tokens launched here graduate to the general market at just 3 ZEC in the curve, instead of the normal threshold. Only reliquia holders can launch one.",
    zh: "在这里发行的代币只需在曲线中累积 3 ZEC 即可毕业进入公开市场，远低于普通门槛。只有拥有圣物的人才能在此发行代币。",
  },
  "pyramid.locked.title": { en: "You need a Reliquia to enter", zh: "你需要拥有一个圣物才能进入" },
  "pyramid.locked.body": {
    en: "Craft a Reliquia in the Forge (3 Fragmentos, made from 5 Papiros each) to unlock LA PIRAMIDE. Selling your only Reliquia locks you back out.",
  ...
  "pyramid.checkingAccess": { en: "Checking your Reliquia…", zh: "正在检查你的圣物…" },
