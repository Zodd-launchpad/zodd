...
// zodd.fun/nft/test lo pasamos a zodd.fun/nft. Queda todo visible para todo
// el mundo" -- moved here from /nft/test (which is now gone) now that the
// collection is live and public. The old "coming soon" stub that used to
// live at this path is retired.
  ...
  return (
    <div className="container nft-market">
      ...
      <div className="nft-hub">
        <Link href="/nft/mint" className="nft-hub-block">
          ...
          {hubReliquiaImages[0] && <NftMedia src={hubReliquiaImages[0]} alt="" className="nft-hub-block-media" />}
        </Link>
        <button type="button" className="nft-hub-block" onClick={() => goToTab("forge")}>
          ...
          {hubReliquiaImages[1] && <NftMedia src={hubReliquiaImages[1]} alt="" className="nft-hub-block-media" />}
        </button>
      ...
      <div className="nft-market-header">
        ...
        <Link href="/nft/mint" className="btn btn-gold nft-market-mint-btn">
